"""
    Develop a basic ATM.py script that:  
    1. Verifies the user's identity with their PIN  
    2. Handles withdrawal transactions  
    3. Manages deposit transactions  
    4. Displays the account balance  

    Ensure it can be converted into an executable using PyInstaller.
"""
def atm():
    balance = 1000
    pin = 2600
